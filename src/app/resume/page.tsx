  ...
  return (
    <div className="p-3 md:p-5 bg-black font-quicksand">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-0">
        ...
        <div className="lg:col-span-4 p-8 !pt-0 text-gray-400">
          <div className="max-w-4xl space-y-8">
            {/* Header Section */}
            <section
              id="header"
              ref={el => { sectionRefs.current.header = el; }}
              className={`transition-all duration-300 rounded-3xl border border-[#242424] bg-[#141414] p-3 md:p-5 ${
                activeSection === "header" ? "border-l-2  border-blue-400 pl-6" : ""
              }`}
            >
              <div className="mb-8">
            ...
            <section
              ...
              className={`transition-all duration-300 rounded-3xl border border-[#242424] bg-[#141414] p-3 md:p-5 ${
                activeSection === "experience" ? "border-l-2 border-blue-400 pl-6" : ""
              }`}
            >
              <h2 className="text-2xl font-bold mb-6 text-blue-400">WORK EXPERIENCE</h2>
            ...
            <section
              ...
              className={`transition-all duration-300 rounded-3xl border border-[#242424] bg-[#141414] p-3 md:p-5 ${
                activeSection === "freelance" ? "border-l-2 border-blue-400 pl-6" : ""
              }`}
            >
              <h2 className="text-2xl font-bold mb-6 text-blue-400">FREELANCE PROJECTS</h2>
              <div className="space-y-6">
                {resumeData.freelance.map((freelanceWork, index) => (
                  <div key={index}>
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-xl font-semibold">{freelanceWork.title}</h3>
                      <span className="text-gray-400 text-sm">{freelanceWork.period}</span>
                    </div>
                    <div className="space-y-4 text-gray-300">
                      <p>{freelanceWork.description}</p>
                      <div>
                        <h4 className="font-semibold text-white mb-2">Developed custom eCommerce platforms:</h4>
                        <ul className="list-disc list-inside space-y-1 ml-4">
                          {freelanceWork.ecommerceProjects.map((project, idx) => (
                            <li key={idx}>
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside space-y-1 ml-4">
                          {freelanceWork.specializedProjects.map((project, idx) => (
                            <li key={idx}>
                              <strong>{project.name}:</strong> {project.description}
                            </li>
                          ))}
            ...
            <section
              ...
              className={`transition-all duration-300 rounded-3xl border border-[#242424] bg-[#141414] p-3 md:p-5 ${
                activeSection === "projects" ? "border-l-2 border-blue-400 pl-6" : ""
              }`}
            >
            ...
            <section
              ...
              className={`transition-all duration-300 rounded-3xl border border-[#242424] bg-[#141414] p-3 md:p-5 ${
                activeSection === "education" ? "border-l-2 border-blue-400 pl-6" : ""
              }`}
            >
